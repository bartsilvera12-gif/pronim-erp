/**
 * Ejecuta la migración del módulo Sorteos en Supabase.
...
async function main() {
  const sqlPath = join(
    ...
    "supabase",
    "migrations",
    "20250326000003_modulo_sorteos.sql"
  );
  ...
  try {
    ...
    console.log("Conectado. Ejecutando migración Sorteos...");
    await client.query(sql);
    console.log("Migración Sorteos aplicada correctamente.");
  } finally {
    await client.end();
  }
}
