...
const es: Dict = {
  ...
  "Buscar por nombre, RUC o teléfono…": "Buscar por nombre, RUC o teléfono…",
  ...
  "recepción pendiente de ingresar": "recepción pendiente de ingresar",
  "recepciones pendientes de ingresar": "recepciones pendientes de ingresar",
  ...
  "Compra": "Compra", "Ajuste manual": "Ajuste manual",
  "Hasta": "Hasta",
...
const ptBR: Dict = {
  ...
  // /ventas — Caja + listado de órdenes
  "Cobro, facturación y cierre de pedidos": "Cobrança, faturamento e fechamento de pedidos",
  "Para vender primero tenés que abrir caja.": "Para vender, primeiro é preciso abrir o caixa.",
  "Para vender primero tenés que": "Para vender, primeiro é preciso",
  "abrir caja": "abrir o caixa",
  "Resumen de hoy": "Resumo de hoje",
  "Facturación de hoy": "Faturamento de hoje",
  "Total incl. IVA": "Total c/ imposto",
  "Ventas de hoy": "Vendas de hoje",
  // Dashboard simple por sucursal
  "Dashboard": "Painel",
  "Datos de": "Dados de",
  "Datos de tu sucursal.": "Dados da sua filial.",
  "Ventas del mes": "Vendas do mês",
  "Operaciones del mes": "Operações do mês",
  "operación(es)": "operação(ões)",
  "vs mes pasado": "vs mês anterior",
  "mes pasado": "mês anterior",
  "Clientes atendidos": "Clientes atendidos",
  "acumulado": "acumulado",
  "Últimas ventas": "Últimas vendas",
  "Ver todas": "Ver todas",
  "Sin ventas todavía.": "Ainda não há vendas.",
  "Consumidor final": "Consumidor final",
  "Clientes atendidos recientemente": "Clientes atendidos recentemente",
  "Sin clientes atendidos todavía.": "Ainda não há clientes atendidos.",
  "Tel": "Tel",
  "última compra": "última compra",
  "Accesos rápidos": "Acessos rápidos",
  "Nueva atención": "Novo atendimento",
  "Recepciones pendientes": "Recepções pendentes",
  "Meta de la sucursal": "Meta da filial",
  "Hoy": "Hoje",
  ...
  "Por orden de venta": "Por ordem de venda",
  "Unidades vendidas": "Unidades vendidas",
  "Unidades despachadas": "Unidades despachadas",
  "Órdenes de venta": "Ordens de venda",
  "Nueva venta": "Nova venda",
  "Buscar por número, producto o SKU...": "Buscar por número, produto ou SKU...",
  "Filtrar por tipo de venta": "Filtrar por tipo de venda",
  "Filtrar por IVA": "Filtrar por imposto",
  "Todos los IVA": "Todos os impostos",
  "Contado": "À vista",
  "Crédito": "A prazo",
  "Exenta": "Isenta",
  "ventas": "vendas",
  ...
  "Pago": "Pagamento",
  "Ticket": "Comprovante",
  "Cargando ventas…": "Carregando vendas…",
  "No hay ventas registradas": "Não há vendas registradas",
  "Ninguna venta coincide con los filtros": "Nenhuma venda corresponde aos filtros",
  ...
  "Buscar por nombre, RUC o teléfono…": "Buscar por nome, CPF/CNPJ ou telefone…",
  ...
  "recepción pendiente de ingresar": "recepção pendente de ingresso",
  "recepciones pendientes de ingresar": "recepções pendentes de ingresso",
  ...
  // ── Segunda tanda: todo lo que quedaba cayendo al español ──────────────
  // Las sucursales que cobran en R$ ahora van enteras en portugués, así que
  // cualquier t() sin entrada acá se veía mezclado.
  "Acciones": "Ações",
  "Ajustes": "Ajustes",
  "Anulada": "Cancelada",
  "Anuladas": "Canceladas",
  ...
  "Buscar": "Buscar",
  "Cant.": "Qtd.",
  "Cargá al menos una prenda que el cliente lleva": "Carregue pelo menos uma peça que o cliente leva",
  "Catálogo (web)": "Catálogo (site)",
  "Cierre proyectado": "Fechamento projetado",
  "Cliente": "Cliente",
  "Comisión del mes": "Comissão do mês",
  "Completadas": "Concluídas",
  "Compras de hoy": "Compras de hoje",
  "Compras del mes": "Compras do mês",
  "Con descuento": "Com desconto",
  "Cortesía": "Cortesia",
  "Cover": "Capa",
  "Cover (imagen destacada)": "Capa (imagem destacada)",
  "Cuerpo": "Corpo",
  "Cómo vamos": "Como estamos",
  "Desc.": "Desc.",
  "Descripción": "Descrição",
  "Descuento general": "Desconto geral",
  "Descuento por línea": "Desconto por linha",
  "Destacado": "Destaque",
  "Detalles del producto (opcional)": "Detalhes do produto (opcional)",
  "Edad": "Idade",
  "Editar post": "Editar post",
  "Editar producto": "Editar produto",
  "Editar tesoro": "Editar tesouro",
  "Ej: 5 tips para organizar el placard": "Ex: 5 dicas para organizar o guarda-roupa",
  "Ej: Converse All Star talle 27": "Ex: Converse All Star tamanho 27",
  "Ej: Recién llegados": "Ex: Recém-chegados",
  "Ej: Vestido floral talle 4": "Ex: Vestido floral tamanho 4",
  "El mes va": "O mês está em",
  "El nombre es obligatorio.": "O nome é obrigatório.",
  "El título es obligatorio.": "O título é obrigatório.",
  "Elegí una o escribí nueva": "Escolha uma ou escreva uma nova",
  "Eliminar": "Excluir",
  "Entradas": "Entradas",
  "Enviando…": "Enviando…",
  "Equipo Akakua'a": "Equipe Akakua'a",
  "Escribí acá el contenido de la nota…": "Escreva aqui o conteúdo da matéria…",
  "Este mes": "Este mês",
  "Excerpt (bajada)": "Resumo (linha de apoio)",
  "Falta elegir un cliente arriba": "Falta escolher um cliente acima",
  "Filtrar desde la fecha": "Filtrar a partir da data",
  "Filtrar hasta la fecha": "Filtrar até a data",
  "Filtrar por categoría": "Filtrar por categoria",
  "Filtrar por estado": "Filtrar por status",
  "Filtrar por forma de pago": "Filtrar por forma de pagamento",
  "Filtrar por sucursal": "Filtrar por filial",
  "Forma de pago": "Forma de pagamento",
  "Foto": "Foto",
  "Fotos y videos que aparecen en el carrusel «Tesoros que acaban de llegar» del sitio público.": "Fotos e vídeos que aparecem no carrossel «Tesouros que acabaram de chegar» do site público.",
  "Guardando…": "Salvando…",
  "Hace 7d": "Há 7 dias",
  "Historial de ventas": "Histórico de vendas",
  "Historial del cliente": "Histórico do cliente",
  "Hoy vs ayer": "Hoje vs ontem",
  "Hoy vs mismo día semana pasada": "Hoje vs mesmo dia da semana passada",
  "Imagen": "Imagem",
  "Intercambio": "Troca",
  "La URL es obligatoria.": "A URL é obrigatória.",
  "La imagen URL es obligatoria.": "A URL da imagem é obrigatória.",
  "Las categorías se generan automáticamente a partir de los productos cargados. Escribí una nueva para crearla.": "As categorias são geradas automaticamente a partir dos produtos cadastrados. Escreva uma nova para criá-la.",
  "Limpiar filtro": "Limpar filtro",
  "Manteniendo este ritmo cerrás en": "Mantendo esse ritmo, você fecha em",
  "Menor = primero en el carrusel.": "Menor = primeiro no carrossel.",
  "Menor = primero.": "Menor = primeiro.",
  "Mes": "Mês",
  "Mes actual vs mes anterior (mismo rango)": "Mês atual vs mês anterior (mesmo período)",
  "Mes prev.": "Mês ant.",
  "Meta del día": "Meta do dia",
  "Motivo de anulación": "Motivo do cancelamento",
  "Movimientos de stock generados": "Movimentações de estoque geradas",
  "Necesario/día": "Necessário/dia",
  "Necesitás vender": "Você precisa vender",
  "Negociación": "Negociação",
  "No hay posts con esos filtros.": "Não há posts com esses filtros.",
  "No hay productos en esa categoría.": "Não há produtos nessa categoria.",
  "Notas y artículos que aparecen en /blog del sitio público.": "Matérias e artigos que aparecem em /blog do site público.",
  "Nuevo post": "Novo post",
  "Nuevo tesoro": "Novo tesouro",
  "Opcional.": "Opcional.",
  "Opcional. Se muestra como badge en la web.": "Opcional. Aparece como selo no site.",
  "Orden": "Ordem",
  "Pegá una URL o subí un archivo →": "Cole uma URL ou envie um arquivo →",
  "Período": "Período",
  "Podés sembrar el conjunto inicial acordado con el cliente (Gs. 6.000, 9.000, 14.000, 19.000, 24.000, 29.000 y luego cada 5.000 hasta 99.000) o crear las tuyas manualmente abajo.": "Você pode semear o conjunto inicial combinado com o cliente (Gs. 6.000, 9.000, 14.000, 19.000, 24.000, 29.000 e depois de 5.000 em 5.000 até 99.000) ou criar as suas manualmente abaixo.",
  "Precio": "Preço",
  "Precio (Gs.)": "Preço",
  "Preview": "Pré-visualização",
  "Producto con defecto": "Produto com defeito",
  "Producto o SKU...": "Produto ou SKU...",
  "Productos curados que aparecen en la página /catalogo del sitio público. Módulo aparte de «Categorías de precio».": "Produtos selecionados que aparecem na página /catalogo do site público. Módulo separado de «Faixas de preço».",
  "Promoción": "Promoção",
  "Proyección de cierre": "Projeção de fechamento",
  "Publicado": "Publicado",
  "Publicados": "Publicados",
  "Quedan": "Faltam",
  "Quitar fechas": "Remover datas",
  "Redondeo": "Arredondamento",
  "Resultado líquido hoy": "Resultado líquido hoje",
  "Resumen que se muestra en la card del listado.": "Resumo exibido no card da listagem.",
  "Ritmo actual": "Ritmo atual",
  "SKU franja (opcional)": "SKU da faixa (opcional)",
  "Salidas": "Saídas",
  "Se autogenera del título si lo dejás vacío": "É gerado a partir do título se deixar em branco",
  "Sembrando…": "Semeando…",
  "Sembrar categorías iniciales": "Semear faixas iniciais",
  "Sin meta configurada": "Sem meta configurada",
  "Slug (URL)": "Slug (URL)",
  "Solo super_admin puede administrar el blog del sitio.": "Apenas o super_admin pode administrar o blog do site.",
  "Solo super_admin puede administrar el catálogo del sitio.": "Apenas o super_admin pode administrar o catálogo do site.",
  "Solo super_admin puede administrar los tesoros del sitio.": "Apenas o super_admin pode administrar os tesouros do site.",
  "Subiendo…": "Enviando…",
  "Subir": "Enviar",
  "Subir imagen": "Enviar imagem",
  "Subtotal": "Subtotal",
  "Subtotal items": "Subtotal de itens",
  "Subtítulo": "Subtítulo",
  "Subí un archivo desde tu compu o pegá una URL (Cloudinary, etc.). Max 20 MB.": "Envie um arquivo do seu computador ou cole uma URL (Cloudinary, etc.). Máx. 20 MB.",
  "Subí una foto o video desde tu compu, o pegá una URL (Cloudinary, etc.). Max 20 MB. Los videos pasan a 'Video' automáticamente.": "Envie uma foto ou vídeo do seu computador, ou cole uma URL (Cloudinary, etc.). Máx. 20 MB. Os vídeos viram 'Vídeo' automaticamente.",
  "Tesoros (web)": "Tesouros (site)",
  "Ticket promedio del mes": "Ticket médio do mês",
  "Tipo de venta": "Tipo de venda",
  "Todas": "Todas",
  "Todas formas de pago": "Todas as formas de pagamento",
  "Todas las sucursales": "Todas as filiais",
  "Todas las ventas registradas": "Todas as vendas registradas",
  "Todavía no hay posts. Creá el primero con «+ Nuevo post».": "Ainda não há posts. Crie o primeiro com «+ Novo post».",
  "Todavía no hay productos en el catálogo. Creá el primero con «+ Nuevo producto».": "Ainda não há produtos no catálogo. Crie o primeiro com «+ Novo produto».",
  "Todavía no hay tesoros cargados. Creá el primero con «+ Nuevo tesoro».": "Ainda não há tesouros cadastrados. Crie o primeiro com «+ Novo tesouro».",
  "Todavía no hay ventas registradas hoy.": "Ainda não há vendas registradas hoje.",
  "Total": "Total",
  "Total prendas": "Total de peças",
  "Título": "Título",
  "Usá los botones para dar formato: títulos, negrita, listas, imágenes y links.": "Use os botões para formatar: títulos, negrito, listas, imagens e links.",
  "Vendiste": "Você vendeu",
  "Venta no encontrada.": "Venda não encontrada.",
  "Ventas de hoy en esta sucursal": "Vendas de hoje nesta filial",
  "Ver cliente": "Ver cliente",
  "Ver detalle": "Ver detalhe",
  "Video": "Vídeo",
  "Volver al historial": "Voltar ao histórico",
  "bajó": "caiu",
  ...
  "más que ayer": "mais que ontem",
  "por debajo del mes pasado": "abaixo do mês passado",
  "por día para llegar": "por dia para alcançar",
  "post": "post",
  "posts": "posts",
  "producto": "produto",
  "productos": "produtos",
  "sin meta": "sem meta",
  "stock × precio venta": "estoque × preço de venda",
  "subió": "subiu",
  "¿Eliminar este post? Esta acción es permanente.": "Excluir este post? Esta ação é permanente.",
  "¿Eliminar este producto del catálogo? Esta acción es permanente.": "Excluir este produto do catálogo? Esta ação é permanente.",
  "¿Eliminar este tesoro? Esta acción es permanente.": "Excluir este tesouro? Esta ação é permanente.",
  "⚠️ Por debajo del ritmo": "⚠️ Abaixo do ritmo",
  "✓ Dentro del ritmo": "✓ Dentro do ritmo",
  "🚀 Por encima del ritmo": "🚀 Acima do ritmo",

  // ── Menú lateral ───────────────────────────────────────────────────────
  "Agenda": "Agenda",
  "CRM Funnel": "Funil de CRM",
  "Campañas": "Campanhas",
  "Cobranzas": "Cobranças",
  ...
  "Etiquetas": "Etiquetas",
  "Explorar (Excel)": "Explorar (Excel)",
  "Facturación": "Faturamento",
  "Finalizadas": "Finalizadas",
  "Gastos": "Despesas",
  "Gerencia": "Gerência",
  "Gestión Clientes": "Gestão de Clientes",
  "Historial omnicanal": "Histórico omnicanal",
  "Marketing Legacy": "Marketing Legacy",
  ...
  "Sorteos": "Sorteios",
  "Sucursales": "Filiais",
  "Tickets / Comprobantes": "Tickets / Comprovantes",
  "Usuarios": "Usuários",
  "Web": "Site",
  "Órdenes": "Pedidos",

  // ── POS (columna de atención) ──────────────────────────────────────────
  "Cargando categorías…": "Carregando faixas…",
  "Desc. c/u": "Desc. un.",
  "Descuento por unidad (se multiplica por la cantidad)": "Desconto por unidade (multiplica pela quantidade)",
  "Ej: 0991 234 567": "Ex: (31) 99123-4567",
  "Ej: 27.500": "Ex: 27,50",
  "Ej: 80011405-1": "Ex: 123.456.789-00",
  "Ej: Instagram, referida por María…": "Ex: Instagram, indicada pela Maria…",
  "Franja con precio manual": "Faixa com preço manual",
  "Precio unit.": "Preço unit.",
  "Quitar": "Remover",
  "Tipo de prenda (opcional)": "Tipo de peça (opcional)",
};
