...
export default function UsuariosPage() {
  ...
  // Límite del plan levantado en server. La UI ya no bloquea "Nuevo usuario".
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            ...
            <span className="ml-1.5 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-semibold bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
        <input
          ...
          className="w-full max-w-md pl-4 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4FAEB2]"
        />
      </div>
