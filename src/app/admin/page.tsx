...
const SECCIONES: SeccionAdmin[] = [
  ...
  { href: "/explorar",                 emoji: "🔎", titulo: "Explorar (Excel)",      descripcion: "Toda la data del ERP: ventas, clientes, compras, inventario, créditos, caja.", tono: "emerald" },
  { href: "/explorar/ventas",          emoji: "🧾", titulo: "Explorar ventas (Excel)", descripcion: "Elegí columnas, filtrá cada campo, combiná y ordená. Sin reportes fijos.", tono: "emerald" },
  ...
  { href: "/admin/reportes/conciliacion", emoji: "🏦", titulo: "Conciliación (drill)",   descripcion: "Pagos por estado y método. Drill + export para conferir vs extractos.",  tono: "sky" },
