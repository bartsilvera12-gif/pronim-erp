...
import { listUbicacionesPostgrest } from "@/lib/inventario/server/catalogos-postgrest";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const rows = await listUbicacionesPostgrest(jwt, empresaId, { soloActivas: false });
